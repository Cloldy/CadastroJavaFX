...
public class MainApp extends Application {
	 ...
	 * 
	 * @return personData list de Persons
	 */
	...
	public void start(Stage primaryStage) {
		...
		this.primaryStage.getIcons().add(new Image("file:resources/images/1458988194_Death_Note.png"));
	...
	/**
	 * Inicializza o root layout (layout base).
	 */
	 ...
	 * usu√°rio clicar OK, as mudan√ßas s√£o salvasno objeto pessoa fornecido e
	 * retorna true.
	 * 
	 * @param person
	...
	public void loadPersonDataFromFile(File file) {
	    try {
	        ...
	        Dialogs.create()
	                .title("Erro")
	                .masthead("N„o foi possÌvel carregar dados do arquivo:\n" 
	...
	public void savePersonDataToFile(File file) {
	    try {
	        ...
	        Dialogs.create().title("Erro")
	                .masthead("N„o foi possÌvel salvar os dados do arquivo:\n" 
	                          + file.getPath()).showException(e);
	    }
	}
